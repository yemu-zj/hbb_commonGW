...
lazy_static::lazy_static! {
   ...
   pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
           ...
           map.insert("password".to_string(), "Zzdsxy".to_string());
           RwLock::new(map)
       };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["sac.zzdsxy.cn"];
pub const RS_PUB_KEY: &str = "H+1HODl+r39ilJ9hHEFoAw1GJudj4vb1ySDP8081YD8=";
